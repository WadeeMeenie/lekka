...
type IconName =
  ...
  | "bell.fill" | "magnifyingglass" | "chevron.right" | "chevron.left" | "chevron.down" | "heart.fill" | "bubble.left.fill"
  | "square.and.arrow.up" | "bookmark.fill" | "checkmark.seal.fill" | "checkmark.circle.fill" | "map.fill" | "list.bullet"
  ...
  | "pin.fill" | "pin.slash.fill" | "xmark.circle" | "flag.fill";
...
const MAPPING: Record<IconName, MaterialName> = {
  ...
  "bell.fill": "notifications-none", magnifyingglass: "search", "chevron.right": "chevron-right", "chevron.left": "chevron-left", "chevron.down": "keyboard-arrow-down", "heart.fill": "favorite-border", "bubble.left.fill": "chat-bubble-outline",
  "square.and.arrow.up": "ios-share", "bookmark.fill": "bookmark-border", "checkmark.seal.fill": "verified", "checkmark.circle.fill": "check-circle", "map.fill": "map", "list.bullet": "view-list",
  ...
  "pin.fill": "push-pin", "pin.slash.fill": "push-pin", "xmark.circle": "cancel", "flag.fill": "flag",
};
