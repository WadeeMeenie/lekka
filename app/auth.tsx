...
import { getAuthErrorMessage, getConfirmationEmailBody, getConfirmationEmailFooter, getConfirmationEmailIntro, getConfirmationEmailSubject, getPasswordToggleIcon, getPasswordToggleLabel, LEKKA_CONFIRMATION_MESSAGE, LEKKA_PROVIDER_SETUP_MESSAGE } from "@/lib/auth-messages";
...
export default function AuthScreen() {
  ...
  const startProvider = async (provider: LekkaOAuthProvider) => {
    if (!isOAuthProviderEnabled(provider)) {
      Alert.alert(`${providerDisplayName[provider]} sign-in needs setup`, LEKKA_PROVIDER_SETUP_MESSAGE);
      return;
    }
