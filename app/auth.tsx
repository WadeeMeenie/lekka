  ...
  const submit = async () => {
    ...
    try {
      ...
      if (isAuthTimeout(error)) {
        ...
        Alert.alert("Sign-in unavailable", asyncErrorMessage(error, "Sign-in unavailable. Check your details and try again."));
      }
    } finally {
      setBusy(false);
    }
