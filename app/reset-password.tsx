...
import { ActivityIndicator, Alert, Animated, BackHandler, KeyboardAvoidingView, Modal, Platform, Pressable, ScrollView, StyleSheet, Text, TextInput, View } from "react-native";
...
export default function ResetPasswordScreen() {
  ...
  const generatePassword = () => {
    const generated = createSecurePassword(passwordLength);
...
const styles = StyleSheet.create({
  ...
  generateActions: { flexDirection: "row", gap: 8, marginBottom: 5 },
  copyButton: { flex: 1, minHeight: 48, borderRadius: 14, borderWidth: 1, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7 },
  copyButtonText: { fontSize: 13, fontWeight: "900" },
  settingsButton: { width: 48, minHeight: 48, borderRadius: 14, borderWidth: 1, alignItems: "center", justifyContent: "center" },
  ...
  toast: { position: "absolute", left: 24, right: 24, bottom: 18, minHeight: 46, borderRadius: 14, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingHorizontal: 16 },
  toastText: { fontSize: 13, fontWeight: "800" },
  modalBackdrop: { flex: 1, backgroundColor: "rgba(0,0,0,0.48)", justifyContent: "flex-end" },
  modalCard: { borderTopLeftRadius: 24, borderTopRightRadius: 24, borderWidth: 1, padding: 24, paddingBottom: 32 },
  modalTitle: { fontSize: 20, fontWeight: "900" },
  modalSubtitle: { fontSize: 12, fontWeight: "800", marginTop: 20, marginBottom: 10 },
  lengthOptions: { flexDirection: "row", gap: 8 },
  lengthOption: { flex: 1, minHeight: 44, borderRadius: 12, borderWidth: 1, alignItems: "center", justifyContent: "center" },
  characterSummary: { fontSize: 14, fontWeight: "700" },
  modalNote: { fontSize: 11, lineHeight: 16, marginTop: 6 },
  modalDone: { minHeight: 48, borderRadius: 14, alignItems: "center", justifyContent: "center", marginTop: 22 },
  modalDoneText: { color: "#10211D", fontSize: 14, fontWeight: "900" },
