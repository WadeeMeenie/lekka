...
import { getFollowState, getPublicProfile, reportContent, toggleBlock, toggleFollow, type SocialProfile, type SocialPost } from "@/lib/social-repository";
...
export default function PublicProfileScreen() {
  ...
  useEffect(() => {
    if (!id) return;
    let mounted = true;
    void Promise.all([getPublicProfile(id), getFollowState(id), listPublicProfilePosts(id, null)]).then(([profileResult, followResult, postsResult]) => {
      if (!mounted) return;
