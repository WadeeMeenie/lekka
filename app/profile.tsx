...
export default function ProfileScreen() {
  ...
  const save = async () => { setBusy(true); const result = await saveMyProfile({ displayName, username: username.toLowerCase().replace(/\s+/g, ""), bio, homeArea: area, preferredRadiusM: 5000, interests }); setBusy(false); if (result.error) Alert.alert("Profile not saved", user ? "We couldn't save your changes. Check your connection and try again." : "Create an account to save a profile."); else Alert.alert("Profile updated", "Your Lekka profile is ready."); };
...
const styles = StyleSheet.create({ content: { padding: 24, paddingBottom: 50 }, loadingCard: { minHeight: 48, borderWidth: 1, borderRadius: 15, justifyContent: "center", paddingHorizontal: 14, marginBottom: 8 }, loadingText: { fontSize: 13, fontWeight: "700" }, errorText: { fontSize: 12, lineHeight: 17, marginBottom: 8 }, back: { flexDirection: "row", alignItems: "center", gap: 5, marginBottom: 24 }, backIcon: { transform: [{ rotate: "180deg" }] }, backText: { fontSize: 14, fontWeight: "700" }, avatar: { width: 70, height: 70, borderRadius: 24, alignItems: "center", justifyContent: "center" }, avatarText: { fontSize: 20, fontWeight: "900", color: "#10211D" }, title: { fontSize: 27, lineHeight: 33, fontWeight: "800", marginTop: 16 }, subtitle: { fontSize: 13, lineHeight: 18, marginTop: 5, marginBottom: 18 }, completionCard: { borderWidth: 1, borderRadius: 17, padding: 14, marginBottom: 8 }, completionHeader: { gap: 3 }, completionTitle: { fontSize: 14, fontWeight: "900" }, completionMeta: { fontSize: 11 }, progressTrack: { height: 7, borderRadius: 4, marginTop: 12, overflow: "hidden" }, progressFill: { height: 7, borderRadius: 4 }, label: { fontSize: 10, fontWeight: "800", letterSpacing: 1.1, marginTop: 12, marginBottom: 7 }, input: { minHeight: 50, borderWidth: 1, borderRadius: 15, paddingHorizontal: 14, fontSize: 15 }, bio: { minHeight: 95, paddingTop: 14, textAlignVertical: "top" }, chips: { flexDirection: "row", flexWrap: "wrap", gap: 7 }, chip: { borderWidth: 1, borderRadius: 13, paddingHorizontal: 10, paddingVertical: 8 }, chipText: { fontSize: 11, fontWeight: "700" }, themes: { gap: 8 }, theme: { borderWidth: 1.5, borderRadius: 15, padding: 9, flexDirection: "row", alignItems: "center", gap: 10 }, themePreview: { width: 42, height: 34, borderRadius: 10, justifyContent: "center", padding: 8 }, themeDot: { width: 12, height: 12, borderRadius: 6 }, themeText: { fontSize: 13, fontWeight: "800" }, primary: { minHeight: 52, borderRadius: 16, alignItems: "center", justifyContent: "center", marginTop: 20 }, primaryText: { fontSize: 15, fontWeight: "800", color: "#10211D" }, savedLink: { minHeight: 48, borderWidth: 1, borderRadius: 15, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, marginTop: 10 }, savedLinkText: { fontSize: 13, fontWeight: "800" }, logout: { alignItems: "center", padding: 16 }, logoutText: { fontWeight: "800", fontSize: 13 },
});
