...
export default function ProfileScreen() {
  ...
  const save = async () => {
    ...
    if (Object.keys(errors).length > 0) {
      Alert.alert("Check your profile", errors.displayName ?? errors.bio ?? "Review your profile details and try again.");
      return;
    }
    setBusy(true);
