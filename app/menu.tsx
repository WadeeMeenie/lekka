...
export default function MenuScreen() {
  ...
  const visibleMenuItems = isPlatformAdmin
    ? [...menuItems, { title: "Yoco TEST setup", detail: "Create the secure Yoco payment webhook", icon: "creditcard.fill" as Parameters<typeof IconSymbol>[0]["name"], route: "/admin-yoco" }]
    : menuItems;
