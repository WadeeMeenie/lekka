...
export default function OnboardingScreen() {
  ...
  useEffect(() => {
    void loadOnboardingState().then((saved) => {
      if (saved.completed && params.resume !== "1") { router.replace("/(tabs)"); return; }
