...
const styles = StyleSheet.create({
  content: { padding: 16, paddingBottom: 36 }, headerRow: { minHeight: 52, justifyContent: "center" }, headerCopy: { flex: 1 }, eyebrow: { fontSize: 11, fontWeight: "600", letterSpacing: 0.8, textTransform: "uppercase" }, title: { fontSize: 28, lineHeight: 34, fontWeight: "700", marginTop: 2 }, search: { borderWidth: 1, borderRadius: 14, height: 48, marginTop: 10, paddingHorizontal: 14, flexDirection: "row", alignItems: "center", gap: 9 }, searchInput: { flex: 1, fontSize: 14 }, categoryRow: { gap: 8, paddingTop: 12, paddingRight: 16 }, categoryChip: { minHeight: 36, paddingHorizontal: 12, borderRadius: 999, borderWidth: 1, flexDirection: "row", alignItems: "center", gap: 7 }, categoryText: { fontSize: 13, fontWeight: "500" }, resultHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 20, marginBottom: 10 }, sectionTitle: { fontSize: 20, lineHeight: 26, fontWeight: "700" }, resultMeta: { fontSize: 12 }, skeletonGroup: { gap: 10 }, skeleton: { height: 88, borderRadius: 14 }, empty: { minHeight: 160, borderWidth: 1, borderRadius: 18, padding: 20, alignItems: "center", justifyContent: "center" }, emptyIcon: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center", marginBottom: 9 }, emptyTitle: { fontSize: 15, lineHeight: 20, fontWeight: "700", textAlign: "center" }, emptyText: { maxWidth: 300, fontSize: 12, lineHeight: 17, textAlign: "center", marginTop: 4 }, ghostButton: { minHeight: 44, justifyContent: "center", paddingHorizontal: 10 }, ghostText: { fontSize: 13, fontWeight: "600" }, listing: { minHeight: 76, flexDirection: "row", alignItems: "center", borderWidth: 1, borderRadius: 14, padding: 12, marginBottom: 8 }, listingIcon: { width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center", marginRight: 11 }, listingCopy: { flex: 1, minWidth: 0 }, listingTitle: { fontSize: 15, lineHeight: 20, fontWeight: "700" }, listingMeta: { fontSize: 12, lineHeight: 16, marginTop: 2 }, listingDescription: { fontSize: 12, lineHeight: 17, marginTop: 2 }, pressed: { opacity: 0.8, transform: [{ scale: 0.99 }] }, sheetOverlay: { flex: 1, justifyContent: "flex-end", backgroundColor: "rgba(0,0,0,0.55)" }, sheetDismiss: { flex: 1 }, sheet: { borderTopLeftRadius: 18, borderTopRightRadius: 18, padding: 20, paddingBottom: 28 }, grabber: { width: 36, height: 4, borderRadius: 2, alignSelf: "center", marginBottom: 18 }, sheetTitle: { fontSize: 20, lineHeight: 26, fontWeight: "700" }, sheetMeta: { fontSize: 12, marginTop: 4 }, sheetBody: { fontSize: 15, lineHeight: 22, marginTop: 16 }, sheetButton: { minHeight: 44, borderRadius: 12, alignItems: "center", justifyContent: "center", marginTop: 20 }, sheetButtonText: { fontSize: 14, fontWeight: "700" },
});
