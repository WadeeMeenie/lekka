...
function PostActionSheet({sheet,colors,onClose,onNotInterested,onReact,onShareExternal,onShareAsPost,onDelete,onEdit}:{sheet:{type:"post"|"reaction"|"share"|"delete";post?:LocalPost};colors:ReturnType<typeof useColors>;onClose:()=>void;onNotInterested:(postId:string)=>void;onReact:(postId:string,reaction:ReactionType)=>void;onShareExternal:(post:LocalPost)=>void;onShareAsPost:(post:LocalPost)=>void;onDelete:(postId:string)=>void;onEdit:(postId:string)=>void}) {
