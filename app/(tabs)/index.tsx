...
import { createSignedMediaUrl, getUnreadNotificationCount } from "@/lib/social-repository";
...
function PostCard({ post, colors, onOpen, onLike, onProtectedAction }: { post: LocalPost; colors: ReturnType<typeof useColors>; onOpen: () => void; onLike: () => void; onProtectedAction: (action: string) => void }) {
